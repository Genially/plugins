---
layout: default
title: Elements item Item.Item
parent: Classes
grand_parent: Reference
permalink: docs/reference/classes/elements_item_Item.Item.html
---

[@genially/plugin-api-view](../README.html) / [Modules](../modules.html) / [elements/item/Item](../modules/elements_item_Item.html) / Item

# Class: Item\<IT, EP\>

[elements/item/Item](../modules/elements_item_Item.html).Item
...
- [constructor](elements_item_Item.Item.html#constructor)

### Properties

- [id](elements_item_Item.Item.html#id)

### Accessors

- [height](elements_item_Item.Item.html#height)
- [opacity](elements_item_Item.Item.html#opacity)
- [parentItem](elements_item_Item.Item.html#parentitem)
- [parentSlide](elements_item_Item.Item.html#parentslide)
- [rotation](elements_item_Item.Item.html#rotation)
- [shown](elements_item_Item.Item.html#shown)
- [visible](elements_item_Item.Item.html#visible)
- [width](elements_item_Item.Item.html#width)
- [x](elements_item_Item.Item.html#x)
- [y](elements_item_Item.Item.html#y)

### Methods

- [move](elements_item_Item.Item.html#move)
- [on](elements_item_Item.Item.html#on)
- [once](elements_item_Item.Item.html#once)
- [playAnimation](elements_item_Item.Item.html#playanimation)
- [rotate](elements_item_Item.Item.html#rotate)
- [setPosition](elements_item_Item.Item.html#setposition)
- [setSize](elements_item_Item.Item.html#setsize)

## Constructors

### constructor

• **new Item**\<`IT`, `EP`\>(`id`, `geniallyEngine`): [`Item`](elements_item_Item.Item.html)\<`IT`, `EP`\>
...
[`Item`](elements_item_Item.Item.html)\<`IT`, `EP`\>
