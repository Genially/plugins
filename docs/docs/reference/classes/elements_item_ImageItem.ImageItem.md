---
layout: default
title: Elements item ImageItem.ImageItem
parent: Classes
grand_parent: Reference
permalink: docs/reference/classes/elements_item_ImageItem.ImageItem.html
---

[@genially/plugin-api-view](../README.html) / [Modules](../modules.html) / [elements/item/ImageItem](../modules/elements_item_ImageItem.html) / ImageItem

# Class: ImageItem

[elements/item/ImageItem](../modules/elements_item_ImageItem.html).ImageItem

Image item

## Hierarchy

- [`Item`](elements_item_Item.Item.html)\<`ItemType.Image`\>
...
- [constructor](elements_item_ImageItem.ImageItem.html#constructor)

### Properties

- [id](elements_item_ImageItem.ImageItem.html#id)

### Accessors

- [height](elements_item_ImageItem.ImageItem.html#height)
- [opacity](elements_item_ImageItem.ImageItem.html#opacity)
- [parentItem](elements_item_ImageItem.ImageItem.html#parentitem)
- [parentSlide](elements_item_ImageItem.ImageItem.html#parentslide)
- [rotation](elements_item_ImageItem.ImageItem.html#rotation)
- [shown](elements_item_ImageItem.ImageItem.html#shown)
- [source](elements_item_ImageItem.ImageItem.html#source)
- [visible](elements_item_ImageItem.ImageItem.html#visible)
- [width](elements_item_ImageItem.ImageItem.html#width)
- [x](elements_item_ImageItem.ImageItem.html#x)
- [y](elements_item_ImageItem.ImageItem.html#y)

### Methods

- [move](elements_item_ImageItem.ImageItem.html#move)
- [on](elements_item_ImageItem.ImageItem.html#on)
- [once](elements_item_ImageItem.ImageItem.html#once)
- [playAnimation](elements_item_ImageItem.ImageItem.html#playanimation)
- [rotate](elements_item_ImageItem.ImageItem.html#rotate)
- [setPosition](elements_item_ImageItem.ImageItem.html#setposition)
- [setSize](elements_item_ImageItem.ImageItem.html#setsize)

## Constructors

### constructor

• **new ImageItem**(`id`, `geniallyEngine`): [`ImageItem`](elements_item_ImageItem.ImageItem.html)
...
[`ImageItem`](elements_item_ImageItem.ImageItem.html)
...
[plugin-api-view/src/elements/item/ImageItem.ts:13](https://github.com/Genially/mono-genially/blob/97703588208/packages/plugin-api-view/src/elements/item/ImageItem.ts#L13)

• `set` **source**(`newValue`): `void`
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `newValue` | `string` | String with new value of source |
...
[plugin-api-view/src/elements/item/ImageItem.ts:22](https://github.com/Genially/mono-genially/blob/97703588208/packages/plugin-api-view/src/elements/item/ImageItem.ts#L22)
