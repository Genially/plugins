---
layout: default
title: Elements item InputItem.InputItem
parent: Classes
grand_parent: Reference
permalink: docs/reference/classes/elements_item_InputItem.InputItem.html
---

[@genially/plugin-api-view](../README.html) / [Modules](../modules.html) / [elements/item/InputItem](../modules/elements_item_InputItem.html) / InputItem

# Class: InputItem

[elements/item/InputItem](../modules/elements_item_InputItem.html).InputItem
...
- [constructor](elements_item_InputItem.InputItem.html#constructor)

### Properties

- [id](elements_item_InputItem.InputItem.html#id)

### Accessors

- [height](elements_item_InputItem.InputItem.html#height)
- [opacity](elements_item_InputItem.InputItem.html#opacity)
- [parentItem](elements_item_InputItem.InputItem.html#parentitem)
- [parentSlide](elements_item_InputItem.InputItem.html#parentslide)
- [rotation](elements_item_InputItem.InputItem.html#rotation)
- [shown](elements_item_InputItem.InputItem.html#shown)
- [visible](elements_item_InputItem.InputItem.html#visible)
- [width](elements_item_InputItem.InputItem.html#width)
- [x](elements_item_InputItem.InputItem.html#x)
- [y](elements_item_InputItem.InputItem.html#y)

### Methods

- [move](elements_item_InputItem.InputItem.html#move)
- [on](elements_item_InputItem.InputItem.html#on)
- [once](elements_item_InputItem.InputItem.html#once)
- [playAnimation](elements_item_InputItem.InputItem.html#playanimation)
- [rotate](elements_item_InputItem.InputItem.html#rotate)
- [setPosition](elements_item_InputItem.InputItem.html#setposition)
- [setSize](elements_item_InputItem.InputItem.html#setsize)
- [setStyles](elements_item_InputItem.InputItem.html#setstyles)

## Constructors

### constructor

• **new InputItem**(`id`, `geniallyEngine`): [`InputItem`](elements_item_InputItem.InputItem.html)
...
[`InputItem`](elements_item_InputItem.InputItem.html)
...
Set the styles of input.

#### Parameters

| Name | Type |
| :------ | :------ |
| `styles` | `Partial`\<`InputStyleSnapshotOut`\> |
...
Depending on the type of the input, these new styles may not have an effect.

#### Defined in

[plugin-api-view/src/elements/item/InputItem.ts:22](https://github.com/Genially/mono-genially/blob/97703588208/packages/plugin-api-view/src/elements/item/InputItem.ts#L22)
