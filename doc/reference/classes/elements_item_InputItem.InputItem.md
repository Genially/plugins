[@genially/plugin-api-view](../README.md) / [Modules](../modules.md) / [elements/item/InputItem](../modules/elements_item_InputItem.md) / InputItem

# Class: InputItem

[elements/item/InputItem](../modules/elements_item_InputItem.md).InputItem

Input item

## Hierarchy

- [`Item`](elements_item_Item.Item.md)\<`ItemType.RichContent`\>
...
- [constructor](elements_item_InputItem.InputItem.md#constructor)

### Properties

- [id](elements_item_InputItem.InputItem.md#id)

### Accessors

- [height](elements_item_InputItem.InputItem.md#height)
- [opacity](elements_item_InputItem.InputItem.md#opacity)
- [parentItem](elements_item_InputItem.InputItem.md#parentitem)
- [parentSlide](elements_item_InputItem.InputItem.md#parentslide)
- [rotation](elements_item_InputItem.InputItem.md#rotation)
- [shown](elements_item_InputItem.InputItem.md#shown)
- [visible](elements_item_InputItem.InputItem.md#visible)
- [width](elements_item_InputItem.InputItem.md#width)
- [x](elements_item_InputItem.InputItem.md#x)
- [y](elements_item_InputItem.InputItem.md#y)

### Methods

- [move](elements_item_InputItem.InputItem.md#move)
- [on](elements_item_InputItem.InputItem.md#on)
- [once](elements_item_InputItem.InputItem.md#once)
- [playAnimation](elements_item_InputItem.InputItem.md#playanimation)
- [rotate](elements_item_InputItem.InputItem.md#rotate)
- [setPosition](elements_item_InputItem.InputItem.md#setposition)
- [setSize](elements_item_InputItem.InputItem.md#setsize)
- [setStyles](elements_item_InputItem.InputItem.md#setstyles)

## Constructors

### constructor

• **new InputItem**(`id`, `geniallyEngine`): [`InputItem`](elements_item_InputItem.InputItem.md)
