[@genially/plugin-api-view](../README.md) / [Modules](../modules.md) / [elements/item/ImageItem](../modules/elements_item_ImageItem.md) / ImageItem

# Class: ImageItem

[elements/item/ImageItem](../modules/elements_item_ImageItem.md).ImageItem

Image item

## Hierarchy

- [`Item`](elements_item_Item.Item.md)\<`ItemType.Image`\>
...
- [constructor](elements_item_ImageItem.ImageItem.md#constructor)

### Properties

- [id](elements_item_ImageItem.ImageItem.md#id)

### Accessors

- [height](elements_item_ImageItem.ImageItem.md#height)
- [opacity](elements_item_ImageItem.ImageItem.md#opacity)
- [parentItem](elements_item_ImageItem.ImageItem.md#parentitem)
- [parentSlide](elements_item_ImageItem.ImageItem.md#parentslide)
- [rotation](elements_item_ImageItem.ImageItem.md#rotation)
- [shown](elements_item_ImageItem.ImageItem.md#shown)
- [source](elements_item_ImageItem.ImageItem.md#source)
- [visible](elements_item_ImageItem.ImageItem.md#visible)
- [width](elements_item_ImageItem.ImageItem.md#width)
- [x](elements_item_ImageItem.ImageItem.md#x)
- [y](elements_item_ImageItem.ImageItem.md#y)

### Methods

- [move](elements_item_ImageItem.ImageItem.md#move)
- [on](elements_item_ImageItem.ImageItem.md#on)
- [once](elements_item_ImageItem.ImageItem.md#once)
- [playAnimation](elements_item_ImageItem.ImageItem.md#playanimation)
- [rotate](elements_item_ImageItem.ImageItem.md#rotate)
- [setPosition](elements_item_ImageItem.ImageItem.md#setposition)
- [setSize](elements_item_ImageItem.ImageItem.md#setsize)

## Constructors

### constructor

• **new ImageItem**(`id`, `geniallyEngine`): [`ImageItem`](elements_item_ImageItem.ImageItem.md)
