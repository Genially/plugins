[@genially/plugin-api-view](../README.md) / [Modules](../modules.md) / [elements/item/ChartTableItem](../modules/elements_item_ChartTableItem.md) / ChartTableItem

# Class: ChartTableItem

[elements/item/ChartTableItem](../modules/elements_item_ChartTableItem.md).ChartTableItem

Chart or table item

## Hierarchy

- [`Item`](elements_item_Item.Item.md)\<`ItemType.Chart`\>
...
- [constructor](elements_item_ChartTableItem.ChartTableItem.md#constructor)

### Properties

- [id](elements_item_ChartTableItem.ChartTableItem.md#id)

### Accessors

- [data](elements_item_ChartTableItem.ChartTableItem.md#data)
- [height](elements_item_ChartTableItem.ChartTableItem.md#height)
- [opacity](elements_item_ChartTableItem.ChartTableItem.md#opacity)
- [parentItem](elements_item_ChartTableItem.ChartTableItem.md#parentitem)
- [parentSlide](elements_item_ChartTableItem.ChartTableItem.md#parentslide)
- [rotation](elements_item_ChartTableItem.ChartTableItem.md#rotation)
- [shown](elements_item_ChartTableItem.ChartTableItem.md#shown)
- [visible](elements_item_ChartTableItem.ChartTableItem.md#visible)
- [width](elements_item_ChartTableItem.ChartTableItem.md#width)
- [x](elements_item_ChartTableItem.ChartTableItem.md#x)
- [y](elements_item_ChartTableItem.ChartTableItem.md#y)

### Methods

- [move](elements_item_ChartTableItem.ChartTableItem.md#move)
- [on](elements_item_ChartTableItem.ChartTableItem.md#on)
- [once](elements_item_ChartTableItem.ChartTableItem.md#once)
- [playAnimation](elements_item_ChartTableItem.ChartTableItem.md#playanimation)
- [rotate](elements_item_ChartTableItem.ChartTableItem.md#rotate)
- [setDataValue](elements_item_ChartTableItem.ChartTableItem.md#setdatavalue)
- [setPosition](elements_item_ChartTableItem.ChartTableItem.md#setposition)
- [setSize](elements_item_ChartTableItem.ChartTableItem.md#setsize)

## Constructors

### constructor

• **new ChartTableItem**(`id`, `geniallyEngine`): [`ChartTableItem`](elements_item_ChartTableItem.ChartTableItem.md)
