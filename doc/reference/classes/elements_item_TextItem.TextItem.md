[@genially/plugin-api-view](../README.md) / [Modules](../modules.md) / [elements/item/TextItem](../modules/elements_item_TextItem.md) / TextItem

# Class: TextItem

[elements/item/TextItem](../modules/elements_item_TextItem.md).TextItem

Text item

## Hierarchy

- [`Item`](elements_item_Item.Item.md)\<`ItemType.Text`\>
...
- [constructor](elements_item_TextItem.TextItem.md#constructor)

### Properties

- [id](elements_item_TextItem.TextItem.md#id)

### Accessors

- [color](elements_item_TextItem.TextItem.md#color)
- [fontFamily](elements_item_TextItem.TextItem.md#fontfamily)
- [fontSize](elements_item_TextItem.TextItem.md#fontsize)
- [height](elements_item_TextItem.TextItem.md#height)
- [opacity](elements_item_TextItem.TextItem.md#opacity)
- [parentItem](elements_item_TextItem.TextItem.md#parentitem)
- [parentSlide](elements_item_TextItem.TextItem.md#parentslide)
- [rotation](elements_item_TextItem.TextItem.md#rotation)
- [shown](elements_item_TextItem.TextItem.md#shown)
- [text](elements_item_TextItem.TextItem.md#text)
- [visible](elements_item_TextItem.TextItem.md#visible)
- [width](elements_item_TextItem.TextItem.md#width)
- [x](elements_item_TextItem.TextItem.md#x)
- [y](elements_item_TextItem.TextItem.md#y)

### Methods

- [move](elements_item_TextItem.TextItem.md#move)
- [on](elements_item_TextItem.TextItem.md#on)
- [once](elements_item_TextItem.TextItem.md#once)
- [playAnimation](elements_item_TextItem.TextItem.md#playanimation)
- [rotate](elements_item_TextItem.TextItem.md#rotate)
- [setPosition](elements_item_TextItem.TextItem.md#setposition)
- [setSize](elements_item_TextItem.TextItem.md#setsize)

## Constructors

### constructor

• **new TextItem**(`id`, `geniallyEngine`): [`TextItem`](elements_item_TextItem.TextItem.md)
