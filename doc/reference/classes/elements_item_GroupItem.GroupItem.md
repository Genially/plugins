[@genially/plugin-api-view](../README.md) / [Modules](../modules.md) / [elements/item/GroupItem](../modules/elements_item_GroupItem.md) / GroupItem

# Class: GroupItem

[elements/item/GroupItem](../modules/elements_item_GroupItem.md).GroupItem

In genially the items can be grouped, this class represents this group

## Hierarchy

- [`Item`](elements_item_Item.Item.md)\<`ItemType.Group`\>
...
- [constructor](elements_item_GroupItem.GroupItem.md#constructor)

### Properties

- [id](elements_item_GroupItem.GroupItem.md#id)

### Accessors

- [groupedItems](elements_item_GroupItem.GroupItem.md#groupeditems)
- [height](elements_item_GroupItem.GroupItem.md#height)
- [opacity](elements_item_GroupItem.GroupItem.md#opacity)
- [parentItem](elements_item_GroupItem.GroupItem.md#parentitem)
- [parentSlide](elements_item_GroupItem.GroupItem.md#parentslide)
- [rotation](elements_item_GroupItem.GroupItem.md#rotation)
- [shown](elements_item_GroupItem.GroupItem.md#shown)
- [visible](elements_item_GroupItem.GroupItem.md#visible)
- [width](elements_item_GroupItem.GroupItem.md#width)
- [x](elements_item_GroupItem.GroupItem.md#x)
- [y](elements_item_GroupItem.GroupItem.md#y)

### Methods

- [move](elements_item_GroupItem.GroupItem.md#move)
- [on](elements_item_GroupItem.GroupItem.md#on)
- [once](elements_item_GroupItem.GroupItem.md#once)
- [playAnimation](elements_item_GroupItem.GroupItem.md#playanimation)
- [rotate](elements_item_GroupItem.GroupItem.md#rotate)
- [setPosition](elements_item_GroupItem.GroupItem.md#setposition)
- [setSize](elements_item_GroupItem.GroupItem.md#setsize)

## Constructors

### constructor

• **new GroupItem**(`id`, `geniallyEngine`): [`GroupItem`](elements_item_GroupItem.GroupItem.md)
...
• `get` **groupedItems**(): [`Item`](elements_item_Item.Item.md)\<`ItemType`, `ItemEventParams`\>[]

All items of group

#### Returns

[`Item`](elements_item_Item.Item.md)\<`ItemType`, `ItemEventParams`\>[]
