---
layout: default
title: Elements item GroupItem.GroupItem
parent: Classes
grand_parent: Reference
permalink: docs/reference/classes/elements_item_GroupItem.GroupItem.html
---

[@genially/plugin-api-view](../README.html) / [Modules](../modules.html) / [elements/item/GroupItem](../modules/elements_item_GroupItem.html) / GroupItem

# Class: GroupItem

[elements/item/GroupItem](../modules/elements_item_GroupItem.html).GroupItem

In genially the items can be grouped, this class represents this group

## Hierarchy

- [`Item`](elements_item_Item.Item.html)\<`ItemType.Group`\>
...
- [constructor](elements_item_GroupItem.GroupItem.html#constructor)

### Properties

- [id](elements_item_GroupItem.GroupItem.html#id)

### Accessors

- [groupedItems](elements_item_GroupItem.GroupItem.html#groupeditems)
- [height](elements_item_GroupItem.GroupItem.html#height)
- [opacity](elements_item_GroupItem.GroupItem.html#opacity)
- [parentItem](elements_item_GroupItem.GroupItem.html#parentitem)
- [parentSlide](elements_item_GroupItem.GroupItem.html#parentslide)
- [rotation](elements_item_GroupItem.GroupItem.html#rotation)
- [shown](elements_item_GroupItem.GroupItem.html#shown)
- [visible](elements_item_GroupItem.GroupItem.html#visible)
- [width](elements_item_GroupItem.GroupItem.html#width)
- [x](elements_item_GroupItem.GroupItem.html#x)
- [y](elements_item_GroupItem.GroupItem.html#y)

### Methods

- [move](elements_item_GroupItem.GroupItem.html#move)
- [on](elements_item_GroupItem.GroupItem.html#on)
- [once](elements_item_GroupItem.GroupItem.html#once)
- [playAnimation](elements_item_GroupItem.GroupItem.html#playanimation)
- [rotate](elements_item_GroupItem.GroupItem.html#rotate)
- [setPosition](elements_item_GroupItem.GroupItem.html#setposition)
- [setSize](elements_item_GroupItem.GroupItem.html#setsize)

## Constructors

### constructor

• **new GroupItem**(`id`, `geniallyEngine`): [`GroupItem`](elements_item_GroupItem.GroupItem.html)
...
[`GroupItem`](elements_item_GroupItem.GroupItem.html)
...
• `get` **groupedItems**(): [`Item`](elements_item_Item.Item.html)\<`ItemType`, `ItemEventParams`\>[]

All items of group

#### Returns

[`Item`](elements_item_Item.Item.html)\<`ItemType`, `ItemEventParams`\>[]

**`Example`**

```ts
group.groupedItems.forEach(item => {
  item.shown = false;
});
```
...
[plugin-api-view/src/elements/item/GroupItem.ts:19](https://github.com/Genially/mono-genially/blob/97703588208/packages/plugin-api-view/src/elements/item/GroupItem.ts#L19)
